...
// limitations under the License.
//
// This file is a new class-based refactor scaffold for terrain analysis.
...
namespace terrain_analysis
{
  ...
  public:
          ...
          terrainCloudElev(new pcl::PointCloud<pcl::PointXYZI>())
    {
      ...
      // Further initialization (publishers, subscribers, timers) goes here
      // 声明ros成员
      // #TODO: QOS具体参数待调
      subOdometry_ =
  ...
  private:
    ...
    // Other member variables (状态变量用蛇形命名)
    bool system_inited_;
    int no_data_inited_;
    ...
    // Geometric computation variables (几何计算变量用驼峰命名)
    double vehicleX, vehicleY, vehicleZ;
    double vehicleRoll, vehiclePitch, vehicleYaw;
    double sinVehicleRoll, cosVehicleRoll;
    double sinVehiclePitch, cosVehiclePitch;
    double sinVehicleYaw, cosVehicleYaw;
    double vehicleXRec, vehicleYRec;
