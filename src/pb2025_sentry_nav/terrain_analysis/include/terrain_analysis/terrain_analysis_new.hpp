...
/**
 * @file terrain_analysis_new.hpp
 * @brief 地形分析节点头文件 - 定时器驱动的可组合节点版本
 * @author Hongbiao Zhu
 * @date 2024
 * 
 * @details 
 * 该文件定义了用于机器人导航的地形分析节点类。
 * 主要功能包括：
 * - 点云数据采集与预处理
 * - 基于体素的地形网格管理
 * - 地面高程估计
...
#ifndef TERRAIN_ANALYSIS__TERRAIN_ANALYSIS_NEW_HPP_
#define TERRAIN_ANALYSIS__TERRAIN_ANALYSIS_NEW_HPP_
